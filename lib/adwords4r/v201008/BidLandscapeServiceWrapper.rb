...
# library setup.
require 'adwords4r/v201008/BidLandscapeServiceDriver.rb'

module AdWords
  module V201008
    module BidLandscapeService

      # Wrapper class for the v201008 BidLandscape service.
      ...
      class BidLandscapeServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::BidLandscapeService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::BidLandscapeService
        end
        ...
        def getBidLandscape(selector)
          begin
            ...
            obj = AdWords::V201008::BidLandscapeService::GetBidLandscape.new(selector)
