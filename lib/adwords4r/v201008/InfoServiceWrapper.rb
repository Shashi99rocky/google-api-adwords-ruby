...
# library setup.
require 'adwords4r/v201008/InfoServiceDriver.rb'

module AdWords
  module V201008
    module InfoService

      # Wrapper class for the v201008 Info service.
      ...
      class InfoServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::InfoService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::InfoService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::InfoService::Get.new(selector)
