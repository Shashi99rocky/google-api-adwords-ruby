...
# library setup.
require 'adwords4r/v201008/AdGroupCriterionServiceDriver.rb'

module AdWords
  module V201008
    module AdGroupCriterionService

      # Wrapper class for the v201008 AdGroupCriterion service.
      ...
      class AdGroupCriterionServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::AdGroupCriterionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::AdGroupCriterionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::AdGroupCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::AdGroupCriterionService::AdGroupCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::AdGroupCriterionService::Mutate.new(operations)
