...
# library setup.
require 'adwords4r/v201008/AdGroupAdServiceDriver.rb'

module AdWords
  module V201008
    module AdGroupAdService

      # Wrapper class for the v201008 AdGroupAd service.
      ...
      class AdGroupAdServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::AdGroupAdService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::AdGroupAdService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::AdGroupAdService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::AdGroupAdService::AdGroupAdOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::AdGroupAdService::Mutate.new(operations)
