...
# library setup.
require 'adwords4r/v201008/GeoLocationServiceDriver.rb'

module AdWords
  module V201008
    module GeoLocationService

      # Wrapper class for the v201008 GeoLocation service.
      ...
      class GeoLocationServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::GeoLocationService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::GeoLocationService
        end
        ...
        #
        # Returns:
        # - rval: SOAP::SOAPArray of AdWords::V201008::GeoLocationService::GeoLocation
        #
        # Raises:
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::GeoLocationService::Get.new(selector)
