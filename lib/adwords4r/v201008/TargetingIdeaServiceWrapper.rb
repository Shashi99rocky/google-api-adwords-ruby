...
# library setup.
require 'adwords4r/v201008/TargetingIdeaServiceDriver.rb'

module AdWords
  module V201008
    module TargetingIdeaService

      # Wrapper class for the v201008 TargetingIdea service.
      ...
      class TargetingIdeaServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::TargetingIdeaService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::TargetingIdeaService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::TargetingIdeaService::Get.new(selector)
        ...
        def getBulkKeywordIdeas(selector)
          begin
            AdWords::Service.validate_param('selector',
                selector, AdWords::V201008::TargetingIdeaService::TargetingIdeaSelector)
            # Construct request object and make API call
            obj = AdWords::V201008::TargetingIdeaService::GetBulkKeywordIdeas.new(selector)
