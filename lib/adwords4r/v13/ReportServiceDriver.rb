  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V13::ReportService::ApiException"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/v13", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ],
    [ "",
      "getAllJobs",
