  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201003::InfoService::ApiException_"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/info/v201003", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ]
  ]
