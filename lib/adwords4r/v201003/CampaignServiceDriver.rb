  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201003::CampaignService::ApiException"=>{:namespace=>nil, :use=>"literal", :ns=>"https://adwords.google.com/api/adwords/cm/v201003", :name=>"ApiException", :encodingstyle=>"document"}} }
    ],
    [ "",
      "mutate",
