  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201003::TargetingIdeaService::ApiException_"=>{:namespace=>nil, :use=>"literal", :ns=>"https://adwords.google.com/api/adwords/o/v201003", :name=>"ApiException", :encodingstyle=>"document"}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
