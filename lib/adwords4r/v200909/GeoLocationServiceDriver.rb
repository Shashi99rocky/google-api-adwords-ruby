  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V200909::GeoLocationService::ApiException"=>{:namespace=>nil, :use=>"literal", :ns=>"https://adwords.google.com/api/adwords/cm/v200909", :name=>"ApiException", :encodingstyle=>"document"}} }
    ]
  ]
