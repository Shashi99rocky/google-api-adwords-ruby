...
require 'adwords4r/v201003/TargetingIdeaServiceMappingRegistry'
...
class TargetingIdeaServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com/api/adwords/o/v201003/TargetingIdeaService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201003::TargetingIdeaService::ApiException_"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/o/v201003", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
