...
# library setup.
require 'adwords4r/v201008/CampaignTargetServiceDriver.rb'

module AdWords
  module V201008
    module CampaignTargetService

      # Wrapper class for the v201008 CampaignTarget service.
      ...
      class CampaignTargetServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::CampaignTargetService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::CampaignTargetService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::CampaignTargetService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::CampaignTargetService::CampaignTargetOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::CampaignTargetService::Mutate.new(operations)
