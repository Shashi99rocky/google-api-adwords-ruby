...
require 'adwords4r/v201008/ServicedAccountServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201008::ServicedAccountService::ApiException_"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/mcm/v201008", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ]
  ]
