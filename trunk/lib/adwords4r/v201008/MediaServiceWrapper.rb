...
# library setup.
require 'adwords4r/v201008/MediaServiceDriver.rb'

module AdWords
  module V201008
    module MediaService

      # Wrapper class for the v201008 Media service.
      ...
      class MediaServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::MediaService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::MediaService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::MediaService::Get.new(selector)
        ...
        #
        # Args:
        # - media: SOAP::SOAPArray of AdWords::V201008::MediaService::Media
        #
        # Returns:
        # - rval: SOAP::SOAPArray of AdWords::V201008::MediaService::Media
        #
        # Raises:
        # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
        #
        def upload(media)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::MediaService::Upload.new(media)
