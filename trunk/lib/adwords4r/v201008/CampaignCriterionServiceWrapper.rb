...
# library setup.
require 'adwords4r/v201008/CampaignCriterionServiceDriver.rb'

module AdWords
  module V201008
    module CampaignCriterionService

      # Wrapper class for the v201008 CampaignCriterion service.
      ...
      class CampaignCriterionServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::CampaignCriterionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::CampaignCriterionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::CampaignCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::CampaignCriterionService::CampaignCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::CampaignCriterionService::Mutate.new(operations)
