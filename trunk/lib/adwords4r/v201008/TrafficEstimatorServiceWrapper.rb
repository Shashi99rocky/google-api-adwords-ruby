...
# library setup.
require 'adwords4r/v201008/TrafficEstimatorServiceDriver.rb'

module AdWords
  module V201008
    module TrafficEstimatorService

      # Wrapper class for the v201008 TrafficEstimator service.
      ...
      class TrafficEstimatorServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::TrafficEstimatorService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::TrafficEstimatorService
        end

        # Calls the {get}[http://code.google.com/apis/adwords/v2009/docs/reference/TrafficEstimatorService.html#get] method of the TrafficEstimator service.
        # Check {the online documentation for this method}[http://code.google.com/apis/adwords/v2009/docs/reference/TrafficEstimatorService.html#get].
        #
        # Args:
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::TrafficEstimatorService::Get.new(selector)
