...
require 'adwords4r/v201008/TargetingIdeaServiceMappingRegistry'
...
class TargetingIdeaServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com/api/adwords/o/v201008/TargetingIdeaService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201008::TargetingIdeaService::ApiException_"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/o/v201008", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
