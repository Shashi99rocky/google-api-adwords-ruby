...
# library setup.
require 'adwords4r/v201008/CampaignServiceDriver.rb'

module AdWords
  module V201008
    module CampaignService

      # Wrapper class for the v201008 Campaign service.
      ...
      class CampaignServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::CampaignService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::CampaignService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::CampaignService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::CampaignService::CampaignOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::CampaignService::Mutate.new(operations)
