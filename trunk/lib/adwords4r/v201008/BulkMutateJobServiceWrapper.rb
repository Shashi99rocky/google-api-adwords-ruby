...
# library setup.
require 'adwords4r/v201008/BulkMutateJobServiceDriver.rb'

module AdWords
  module V201008
    module BulkMutateJobService

      # Wrapper class for the v201008 BulkMutateJob service.
      ...
      class BulkMutateJobServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::BulkMutateJobService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::BulkMutateJobService
        end
        ...
        #
        # Returns:
        # - rval: SOAP::SOAPArray of AdWords::V201008::BulkMutateJobService::BulkMutateJob
        #
        # Raises:
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::BulkMutateJobService::Get.new(selector)
        ...
        def mutate(operation)
          begin
            AdWords::Service.validate_param('operation',
                operation, AdWords::V201008::BulkMutateJobService::JobOperation)
            # Construct request object and make API call
            obj = AdWords::V201008::BulkMutateJobService::Mutate.new(operation)
