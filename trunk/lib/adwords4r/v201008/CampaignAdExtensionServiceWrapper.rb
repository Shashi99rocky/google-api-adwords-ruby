...
# library setup.
require 'adwords4r/v201008/CampaignAdExtensionServiceDriver.rb'

module AdWords
  module V201008
    module CampaignAdExtensionService

      # Wrapper class for the v201008 CampaignAdExtension service.
      ...
      class CampaignAdExtensionServiceWrapper
        ...
        # instead of
        #  AdWords::V201008::CampaignAdExtensionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201008::CampaignAdExtensionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201008::CampaignAdExtensionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201008::CampaignAdExtensionService::CampaignAdExtensionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201008::CampaignAdExtensionService::Mutate.new(operations)
