require 'adwords4r/v200909/InfoService'
require 'adwords4r/v200909/InfoServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V200909::InfoService::ApiException_"=>{:namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/info/v200909", :name=>"ApiException", :encodingstyle=>"document", :use=>"literal"}} }
    ]
  ]
